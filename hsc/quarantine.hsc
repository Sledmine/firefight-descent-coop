...
(script static void life_lost
	(if (= (unit_get_health (player)) 0)
		(begin	
			...
			(objects_attach (player) "" dead_biped "")
			(objects_detach (player) dead_biped)
			(unit_kill dead_biped)
			(object_teleport (player) teleport_flag)
...
(script static void loadout_loader
	(if (= loadout 3)
		(player_add_equipment (player) loadout3 true)
	)
	(if (= loadout 2)
		(player_add_equipment (player) loadout2 true)
	)
	(if (= loadout 1)
		(player_add_equipment (player) loadout1 true)
	)
)
(script static void continue_life_lost
	...
	(objects_attach (player) "" spawnball "")
	(objects_detach (player) spawnball)
	(sleep 20)
	(sound_impulse_predict sound\sfx\ui\player_respawn 1)
	(if (<= waves 10)
		(object_teleport (player) respawn_flag_1)
	)
	(if (> waves 10)
		(object_teleport (player) respawn_flag_2)
	)
	...
	(if (< lives 16)
		(begin
			...
			(unit_set_desired_flashlight_state (player) true)
...
(script startup easter
	...
	(sleep_until (unit_has_weapon (player) goldeneye))
	(deactivate_team_nav_point_flag player asskicker_flag)
	(player_enable_input 0)
	(fade_out 1 1 1 5)
	(sleep 5)
	(object_teleport (player) starting_flag)
...
(script startup game_overview
	...
	(sleep 30)
	(object_teleport (player) overview_complete_flag)
	(camera_control 0)
	(cinematic_stop)
	(player_enable_input 1)
	(fade_in 0 0 0 20)
...
(script dormant quarantine
	...
	(set ai_dead false)
	(outside_doors_open)
	(sleep_until (and (<= (ai_living_count combatforms_11-33) 5) (= (volume_test_object death_by_outside_1 (player)) 0) (= (volume_test_object death_by_outside_2 (player)) 0)))
	(outside_doors_close)
	(sleep 60)
	(ai_place combatforms_11-33/challenge_wave_2_p2)
	(outside_doors_open)
	(sleep_until (and (<= (ai_living_count combatforms_11-33) 6) (= (volume_test_object death_by_outside_1 (player)) 0) (= (volume_test_object death_by_outside_2 (player)) 0)))
	(outside_doors_close)
	(sleep 60)
	...
	(set ai_dead false)
	(outside_doors_open)
	(sleep_until (and (<= (ai_living_count combatforms_11-33) 10) (= (volume_test_object death_by_outside_1 (player)) 0) (= (volume_test_object death_by_outside_2 (player)) 0)))
	(outside_doors_close)
	(sleep 60)
	...
	(set ai_dead false)
	(outside_doors_open)
	(sleep_until (and (<= (ai_living_count combatforms_11-33) 11) (= (volume_test_object death_by_outside_1 (player)) 0) (= (volume_test_object death_by_outside_2 (player)) 0)))
	(outside_doors_close)
	(sleep 60)
	...
	(sleep_until (and (<= (ai_living_count combatforms_11-33) 12) (= (volume_test_object death_by_outside_1 (player)) 0) (= (volume_test_object death_by_outside_2 (player)) 0)))
	(outside_doors_close)
	(sleep 60)
	...
	(outside_doors_open)
	(sleep_until (and (<= (ai_living_count combatforms_11-33) 13) (= (volume_test_object death_by_outside_1 (player)) 0) (= (volume_test_object death_by_outside_2 (player)) 0)))
	(outside_doors_close)
	(sleep 60)
	...
	(set ai_dead false)
	(outside_doors_open)
	(sleep_until (and (<= (ai_living_count combatforms_34-44) 12) (= (volume_test_object death_by_outside_1 (player)) 0) (= (volume_test_object death_by_outside_2 (player)) 0)))
	(outside_doors_close)
	(sleep 60)
	...
	(ai_place carriers_11-51/carrier_1)
	(ai_place carriers_11-51/carrier_5)
	(sleep_until (and (<= (ai_living_count combatforms_34-44) 13) (= (volume_test_object death_by_outside_1 (player)) 0) (= (volume_test_object death_by_outside_2 (player)) 0)))
	(outside_doors_close)
	(sleep 60)
	...
	(ai_place carriers_11-51/carrier_3_camo)
	(sleep_until (and (<= (ai_living_count combatforms_34-44) 14) (= (volume_test_object death_by_outside_1 (player)) 0) (= (volume_test_object death_by_outside_2 (player)) 0)))
	(outside_doors_close)
	(sleep 60)
	...
	(set ai_dead false)
	(outside_doors_open)
	(sleep_until (and (<= (ai_living_count combatforms_34-44) 10) (= (volume_test_object death_by_outside_1 (player)) 0) (= (volume_test_object death_by_outside_2 (player)) 0)))
	(outside_doors_close)
	(sleep 60)
	...
	(set ai_dead false)
	(outside_doors_open)
	(sleep_until (and (<= (ai_living_count combatforms_45-51) 13) (= (volume_test_object death_by_outside_1 (player)) 0) (= (volume_test_object death_by_outside_2 (player)) 0)))
	(outside_doors_close)
	(sleep 60)
	...
	(ai_place carriers_11-51/carrier_2)
	(sleep_until (and (<= (ai_living_count combatforms_45-51) 14) (= (volume_test_object death_by_outside_1 (player)) 0) (= (volume_test_object death_by_outside_2 (player)) 0)))
	(outside_doors_close)
	(sleep 60)
	...
	(sleep_until (and (<= (ai_living_count combatforms_45-51) 15) (= (volume_test_object death_by_outside_1 (player)) 0) (= (volume_test_object death_by_outside_2 (player)) 0)))
	(outside_doors_close)
	(sleep 60)
...
(script continuous final_wave
	(if (= wave_of_death true)
		(begin
			...
			(sleep_until (and (<= (ai_living_count combatforms_45-51) 18) (= (volume_test_object death_by_outside_1 (player)) 0) (= (volume_test_object death_by_outside_2 (player)) 0)))
			(outside_doors_close)
			(sleep 60)
...
(script startup reinforcements
	...
	(sleep 30)
	(player_effect_stop 1)
	(activate_nav_point_object team_mate (player) (unit (list_get (ai_actors teammate) 0)) 0.5)
...
(script continuous explosion_state
	(if (= (unit_get_current_flashlight_state (player)) true)
		(begin
			(if (= explosion_one_life true)
				(unit_set_desired_flashlight_state (player) false)
			)
		)
	)
	(sleep 5)
...
(script continuous explosion_starter
	(sleep_until (and (= (unit_get_current_flashlight_state (player)) false) (= explosion_blocker false)))
	(if (= explosion_one_life false)
		(begin
			(set explosion_one_life true)
			(unit_set_desired_flashlight_state (player) false)
			(object_create_anew explosion_effect)
			(objects_attach (player) "" explosion_effect "")
			(objects_detach (player) explosion_effect)
...
(script continuous level_functions
	...
	(if (and (< (ai_living_count combatforms_1-10) 3) (> (ai_living_count combatforms_1-10) 0))
		(begin
			(activate_nav_point_object enemy (player) (unit (list_get (ai_actors combatforms_1-10) 1)) 0.4)
			(activate_nav_point_object enemy (player) (unit (list_get (ai_actors combatforms_1-10) 0)) 0.4)
		)
	)
	(if (and (< (ai_living_count combatforms_11-33) 3) (> (ai_living_count combatforms_11-33) 0))
		(begin
			(activate_nav_point_object enemy (player) (unit (list_get (ai_actors combatforms_11-33) 1)) 0.4)
			(activate_nav_point_object enemy (player) (unit (list_get (ai_actors combatforms_11-33) 0)) 0.4)
		)
	)
	(if (and (< (ai_living_count combatforms_34-44) 3) (> (ai_living_count combatforms_34-44) 0))
		(begin
			(activate_nav_point_object enemy (player) (unit (list_get (ai_actors combatforms_34-44) 1)) 0.4)
			(activate_nav_point_object enemy (player) (unit (list_get (ai_actors combatforms_34-44) 0)) 0.4)
		)
	)
	(if (and (< (ai_living_count combatforms_45-51) 3) (> (ai_living_count combatforms_45-51) 0))
		(begin
			(activate_nav_point_object enemy (player) (unit (list_get (ai_actors combatforms_45-51) 1)) 0.4)
			(activate_nav_point_object enemy (player) (unit (list_get (ai_actors combatforms_45-51) 0)) 0.4)
		)
	)
	(if (= weapondropvalue 12)
	...
	(life_lost)
	(if (= (volume_test_object death_by_fall (player)) 1)
		(begin
			(set dead_by_fall true)
			(object_can_take_damage (player))
			(damage_object quarantine\effects\kill_me (player))
		)
	)
	(if
		(or
			(volume_test_objects death_by_outside_1 (player))
			(volume_test_objects death_by_outside_2 (player))
			(and (volume_test_objects death_by_outside_3 (player)) (= game_started true))
			(volume_test_objects death_by_camping_1 (player))
			(volume_test_objects death_by_camping_2 (player))
		)
		(begin
			(clorox_eyes)
			(show_hud_help_text true)
